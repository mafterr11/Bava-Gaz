...
export default function Hero() {
  return (
    <div className="relative mt-[9.6rem] h-screen w-screen bg-hero bg-cover bg-[bottom_center] bg-no-repeat">
      {/* Black overlay */}
      <div className="absolute inset-0 bg-[#0D0C0BA6]" />
      {/* Hero container */}
      <div className="flex pt-40 flex-col items-center justify-center xl:px-20 2xl:px-0">
