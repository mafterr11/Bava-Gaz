...
const Footer = () => {
  return (
    <footer className="bg-grey-light/50">
      <div className="container border-orange relative z-[2] mx-auto flex w-full flex-col-reverse items-center justify-between gap-y-8 border-t-2 bg-black py-8 font-nunitoSans lg:flex-row xl:px-12">
        {/* Left side */}
