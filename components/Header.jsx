...
const Header = () => {
  return (
    ...
    >
      {/* Top container */}
      <div className="flex w-full items-center justify-center bg-[#082d64] px-10 py-2.5 font-semibold max-md:flex-col max-md:gap-y-1 md:px-16 md:max-lg:justify-between xl:gap-x-32">
        {/* phone */}
      ...
      <div className="w-full bg-black-heavy">
        <div className="container flex w-[85%] items-center justify-between px-0 py-5 md:px-16 md:max-lg:justify-between xl:gap-x-32">
          {/* logo */}
