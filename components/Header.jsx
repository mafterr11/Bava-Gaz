...
const Header = () => {
  return (
    ...
    >
      ...
      {/* Bottom container */}
      <div className="bg-black-heavy w-full">
        <div className="container w-[85%] flex items-center py-5 justify-between px-10 md:px-16 md:max-lg:justify-between xl:gap-x-32">
          {/* logo */}
